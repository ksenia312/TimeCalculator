...
import com.xenikii.timecalculator.shared.extensions.buildRoutineDeepLinkIntent

internal const val ACTION_ROUTINE_ALARM = "com.xenikii.timecalculator.action.ROUTINE_ALARM"
...
fun buildRoutineAlarmIntent(
    ...
    return Intent(context, com.xenikii.timecalculator.data.schedule.receiver.RoutineAlarmReceiver::class.java).apply {
